...
::Variables
SET @FORMAT=BC6H_UF16
SET @InputFolder=%~dp0Input_IMG_TO_BC6H_UF_HDR\
SET @OutputFolder=%~dp0Output_DXT10_BC6H_UF_HDR_NO_MIPMAPS\
...
"%@TEXCONVEXE02%" %@LOGO% -srgb -nogpu -pow2 -vflip -m 1 -if triangle -f %@FORMAT% "%@ISTRING%" -o "%@OSTRING%" -y
ECHO:
SET @LOGO= 
GOTO SCRIPTEND
