...
SET @InputFolder=%~dp0Input_IMG_TO_BC1\
SET @OutputFolder=%~dp0Output_DXT5_BC1_NO_MIPMAPS\
...
"%@TEXCONVEXE02%" %@LOGO% -srgb -nogpu -pow2 m- 1 -vflip -if triangle -bc u -f %@FORMAT% "%@ISTRING%" -o "%@OSTRING%" -y
ECHO:
SET @LOGO= 
GOTO SCRIPTEND
